...
class Employees extends CI_Controller {
  ...
  public function new(){
    ...
    $data['roles'] = $this->User_Model->get_roles_enum("object");
  ...
  public function register(){
    ...
    // $this->form_validation->set_rules('form_confirm_password', 'Password Comfirmation', 'trim|required|matches[form_password]');
    ...
    if($this->form_validation->run() == false){
      ...
      //get enum roles for dropdown
      $data['roles'] = $this->User_Model->get_roles_enum("object"); //gets enum privilege options for users
  ...
  public function password($id){
    ...
    $this->load->view('employees/employees_password_view', $data);
    $this->load->view('templates/footer');
  }


  public function reset_password($id){
    //Get banner_id for db comparison
    $this->form_validation->set_rules('form_password', 'Password', 'trim|required|matches[form_confirm_password]');
