  ...
  <div class="row pl-2 pr-2">
    <div class="col-sm-6 col-lg-6 ml-auto mr-auto mt-5">
      ...
      <div class="form-group">
        ...
        echo form_dropdown('form_role', $roles, $selected, 'class="form-control"');
        ?>
      ...
      <div class="form-group mb-5">
        ...
        <?php if($_SESSION['user_role'] == "Admin"){ ?>
          ...
          <?php $url= base_url()."employees/password/".$employee['banner_id']; ?>
          <a class="btn btn-secondary" href="<?php echo $url; ?>">Reset Password</a>

        <?php } ?>

        <input id="btn_register" name="btn_register" type="submit" class="btn btn-primary float-right" value="Update" />
